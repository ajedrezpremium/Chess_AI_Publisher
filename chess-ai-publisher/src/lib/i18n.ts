...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'chat.name': { es: 'JR Assistant', gl: 'JR Assistant', en: 'JR Assistant' },
  'chat.status': { es: 'Agente IA · Online', gl: 'Axente IA · Online', en: 'AI Agent · Online' },
  'chat.welcome': { es: '¡Hola! Soy el asistente IA de JREDITION. ¿En qué puedo ayudarte?', gl: 'Ola! Son o asistente IA de JREDITION. En que podo axudarche?', en: 'Hello! I am JREDITION\'s AI assistant. How can I help you?' },
